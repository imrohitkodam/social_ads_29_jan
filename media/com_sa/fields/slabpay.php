	...
	public function getInput()
	{
		$js_key = "function checkforalpha(el,allowed_ascii)
		{
			...
			for(i=0;i<el.value.length;i++){
				if(el.value=='0'){
					alert('" . Text::_('COM_SOCIALADS_ZERO_VALUE_VALI_MSG') . "');
			 ...
			 if((el.value.charCodeAt(i) <= 47 || el.value.charCodeAt(i) >= 58) || (el.value.charCodeAt(i) == 45 )){
					if(allowed_ascii !=el.value.charCodeAt(i) ){
						alert('" . Text::_('COM_SOCIALADS_NUMONLY_VALUE_VALI_MSG') . "'); el . value = el . value . substring(0,i); break;
					}
				}
			}
		}";
		...
		$html .= '</div><table class="table table-striped table-responsive sa-elements-custom" style="width:40px;">
					<tbody>
					<tr>
						<td width="2%" align="center" class="title">
							' . HTMLHelper::tooltip(Text::_('COM_SOCIALADS_OPTIONS_SLABS_TITLE_TOOLTIP'), Text::_('COM_SOCIALADS_OPTIONS_SLABS_TITLE'), '', Text::_('COM_SOCIALADS_OPTIONS_SLABS_TITLE')) . '
						</td>
						<td width="2%" align="center" class="title">
							' . HTMLHelper::tooltip(Text::_('COM_SOCIALADS_OPTIONS_SLABS_DURATION_TOOLTIP'), Text::_('COM_SOCIALADS_OPTIONS_SLABS_DURATION'), '', Text::_('COM_SOCIALADS_OPTIONS_SLABS_DURATION')) . '
						</td>
						<td width="2%" align="center" class="title">
							' . HTMLHelper::tooltip(Text::_('COM_SOCIALADS_OPTIONS_SLABS_PRICE_TOOLTIP'), Text::_('COM_SOCIALADS_OPTIONS_SLABS_PRICE'), '', Text::_('COM_SOCIALADS_OPTIONS_SLABS_PRICE')) . '
						</td>
					</tr>';
