...
if (file_exists(JPATH_SITE . "/libraries/ar-php/I18N/Arabic/Glyphs.php"))
{
    include JPATH_SITE . "/libraries/ar-php/I18N/Arabic/Glyphs.php";
}
...
class Text extends AbstractRenderer
{
    ...
    function render(Frame $frame)
    {
        ...
        if (file_exists(JPATH_SITE . "/libraries/ar-php/I18N/Arabic/Glyphs.php") && !class_exists('I18N_Arabic'))
        {
