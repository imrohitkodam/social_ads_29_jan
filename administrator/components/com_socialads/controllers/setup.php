 ...
 * @since    1.8
 */
class SocialAdsControllerSetup extends FormController
{
	/**
	...
	public function setup()
	{
		...
		if (Folder::exists($compOverrideFolder))
		{
			if ($takeBackUp)
			{
				...
				$statusMsg["component"][] = Text::_('COM_SOCIALADS_TAKEN_BACKUP_OF_OVERRIDE_FOLDER') . $backupPath;
			}
			else
			{
		...
		// Copy
		$statusMsg["component"][] = Text::_('COM_SOCIALADS_OVERRIDE_DONE') . $compOverrideFolder;
	...
	public function overrideLayout($templatePath)
	{
		...
		if (Folder::exists($layoutExist))
		{
			Folder::delete($layoutExist);
		}

		Folder::copy($layoutPath, $templatePath . '/layouts/ad');
	}
	...
	{
		echo "<br/> =================================================================================";
		echo "<br/> " . Text::_("COM_SOCIALADS_BS2_OVERRIDE_PROCESS_START");
		echo "<br/> =================================================================================";
		...
		echo "<br/> " . Text::_("COM_SOCIALADS_BS2_OVERRIDING_DONE");
	}
}
