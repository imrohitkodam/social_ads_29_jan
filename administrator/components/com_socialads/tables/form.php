 ...
 * @since  1.0
 */
class SocialadsTableForm extends Table
{
	/**
	 * Constructor.
	 *
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!Factory::getUser()->authorise('core.admin', 'com_socialads.data.' . $array['ad_id']))
		{
			$actions = Access::getActionsFromFile(JPATH_ADMINISTRATOR . '/components/com_socialads/access.xml', "/access/section[@name='data']/");
			$default_actions = Access::getAssetRules('com_socialads.data.' . $array['ad_id'])->getData();
			$array_jaccess   = array();
