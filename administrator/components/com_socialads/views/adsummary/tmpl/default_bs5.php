			...
			<div class="tjDB">
				<div class="container-fluid">
					<div class="row mt-2 mb-2">
						...
						<div class="col-lg-4 col-md-5 col-sm-5 col-xs-9">
							<label for="from" class="hidden-xs"><?php echo Text::_('COM_SOCIALADS_STATS_TO_DATE'); ?></label>
							<?php echo HTMLHelper::_('calendar', $this->to_date, 'to', 'to', '%Y-%m-%d', array('class' => ' input-small input-sm')); ?>

						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 align-self-end">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-6 col-lg-6">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<?php
									if ((isset($this->statsforpie[0]) && $this->statsforpie[0]) > 0 or (isset($this->statsforpie[1]) && $this->statsforpie[1] > 0))
									{?>
