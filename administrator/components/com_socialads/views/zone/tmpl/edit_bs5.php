...
<script type="text/javascript">
	...
	techjoomla.jQuery(document).ready(function()
	{
		...
		// When user finish the filling input data then check for validation
		jQuery('input[name="jform[per_click]"]').change(function() {
			saAdmin.checkForAlpha(this,46);
		});

		jQuery('input[name="jform[per_imp]"]').change(function() {
			saAdmin.checkForAlpha(this,46);
		});

		jQuery('input[name="jform[per_day]"]').change(function() {
			saAdmin.checkForAlpha(this,46);
		});
	...
	window.onload = function() 
	{
		...
		document . getElementById("jform_ad_type") . addEventListener("change", function () {
			autoFill();
			saAdmin.zone.useImageRatioToggle(jQuery('input[name="jform[use_image_ratio]"]'));
		});
...
<form action="<?php echo Route::_('index.php?option=com_socialads&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm" class="form-validate">
	...
	<ul class="nav nav-tabs" id="myTab" role="tablist">
		<li class="nav-item" role="presentation">
			<button class="nav-link active" id="tab1-tab" data-bs-toggle="tab" data-bs-target="#tab1" type="button" role="tab" aria-controls="tab1" aria-selected="true"><?php echo Text::_('COM_SOCIALADS_TITLE_ZONE_BASIC');?></button>
		</li>
		<li class="nav-item" role="presentation">
			<button class="nav-link" id="tab2-tab" data-bs-toggle="tab" data-bs-target="#tab2" type="button" role="tab" aria-controls="tab2" aria-selected="false"><?php echo Text::_('COM_SOCIALADS_TITLE_ZONE_PRICING');?></button>
		</li>
		<li class="nav-item" role="presentation">
			<button class="nav-link" id="tab3-tab" data-bs-toggle="tab" data-bs-target="#tab3" type="button" role="tab" aria-controls="tab3" aria-selected="false"><?php echo Text::sprintf('COM_SOCIALADS_TITLE_ZONE_AD_WIDGET');?></button>
		</li>
	</ul>
	<div class="col-md-10 form-horizontal mt-3">
			...
			<div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
				<fieldset class="adminform">
					...
					<div class="form-group row">
						<div class="form-label col-md-4"><?php echo $this->form->getLabel('zone_name'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('zone_name'); ?></div>
					</div>

					<div class="form-group row">
						<div class="form-label col-md-4"><?php echo $this->form->getLabel('ad_type'); ?></div>
						<div class="controls col-md-8">
							<?php
								...
								echo HTMLHelper::_('select.genericlist', $add_type,'jform[ad_type]', 'class="inputbox form-select" onchange=saAdmin.zone.zoneAdTypes(this.value);', 'value', 'text',$default_layout, 'jform_ad_type' );
							?>
						</div>
					</div>

					<div class="form-group row">
						<div class="form-label col-md-4"><?php echo $this->form->getLabel('orientation'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('orientation'); ?></div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="controls col-md-8">
							<label class="radio inline">
								<input type="radio" name="affiliate" id="affiliate1" value="1"  <?php echo $publish1;?> >
					...
					<?php
						...
						{
						    $default_layout = $allowed_type[0];
						}
					?>

					<div class="form-group row">
						<div class="form-label col-md-4"><?php echo $this->form->getLabel('use_image_ratio'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('use_image_ratio'); ?></div>
					</div>

					<div class="form-group row" id = "img_width">
						<div class="form-label col-md-4"><?php  echo $this->form->getLabel('img_width'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('img_width'); ?></div>
						<span id="validate_img_width" name="validate_img_width" class="invalid validate[numeric]"></span>
					</div>

					<div class="form-group row" id = "img_height">
						<div class="form-label col-md-4"><?php echo $this->form->getLabel('img_height'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('img_height'); ?></div>
						<span id="validate_img_height" name="validate_img_height" class="invalid"></span>
					</div>

					<div class="form-group row" id = "img_width_ratio">
						<div class="form-label col-md-4"><?php  echo $this->form->getLabel('img_width_ratio'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('img_width_ratio'); ?></div>
						<span id="validate_img_width_ratio" name="validate_img_width_ratio" class="invalid validate[numeric]"></span>
					</div>

					<div class="form-group row" id = "img_height_ratio">
						<div class="form-label col-md-4"><?php echo $this->form->getLabel('img_height_ratio'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('img_height_ratio'); ?></div>
						<span id="validate_img_height_ratio" name="validate_img_height_ratio" class="invalid"></span>
					</div>

					<div class="form-group row" id="max_title">
						<div class="form-label col-md-4"><?php echo $this->form->getLabel('max_title'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('max_title'); ?></div>
						<span id="validate_max_title" name="validate_max_title" class="invalid"></span>
					</div>
					<div class="form-group row" id="max_des">
						<div class="form-label col-md-4"><?php echo $this->form->getLabel('max_des'); ?></div>
						<div class="controls col-md-8"><?php echo $this->form->getInput('max_des'); ?></div>
						<span id="validate_max_des" name="validate_max_des" class="invalid"></span>
					</div>
					<div class="form-group row" id="layout_row">
						<div  class = "form-label col-md-4">
			...
			<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
				<fieldset>
					...
					<div class="form-group row">
						...
						<div class="controls col-md-8"><?php echo Text::_('COM_SOCIALADS_ZONE_PRICING_TOOLTIP'); ?> </div>
					</div>
					...
					{ ?>
						...
						<div class="form-group row">
							<div class="form-label col-md-4"><?php echo $this->form->getLabel('per_click'); ?></div>
							<div class="controls col-md-8"><?php echo $this->form->getInput('per_click'); ?></div>
						</div>
					<?php }?>
					<?php if(in_array('perimpression', $pricing_opt)){ ?>
						<div class="form-group row">
							<div class="form-label col-md-4"><?php echo $this->form->getLabel('per_imp'); ?></div>
							<div class="controls col-md-8"><?php echo $this->form->getInput('per_imp'); ?></div>
						</div>
					<?php }?>
					<?php if(in_array('perday', $pricing_opt)){ ?>
						<div class="form-group row">
							<div class="form-label col-md-4"><?php echo $this->form->getLabel('per_day'); ?></div>
							<div class="controls col-md-8"><?php echo $this->form->getInput('per_day'); ?></div>
						</div>
						<?php }
					}?>
				</fieldset>
				...
				<fieldset>
					<div class="row">
						<div class="col-md-6">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link active" id="wtab1-tab" data-bs-toggle="tab" data-bs-target="#wtab1" type="button" role="tab" aria-controls="wtab1" aria-selected="true"><?php echo Text::_('COM_SOCIALADS_ZONE_WIDGET_CUSTOM');?></button>
								</li>
								<?php
								$params=ComponentHelper::getParams('com_socialads');
								...
								{?>
									<li class="nav-item" role="presentation">
										<button class="nav-link" id="wtab2-tab" data-bs-toggle="tab" data-bs-target="#wtab2" type="button" role="tab" aria-controls="wtab2" aria-selected="false"><?php echo Text::_('COM_SOCIALADS_ZONE_WIDGET_TARGET');?></button>
									</li>
								<?php } ?>
							</ul>
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="wtab1" role="tabpanel" aria-labelledby="wtab1-tab">
									<table id="widget" class="table table-bordered " cellspacing="8px">
										<tr>
											...
											<td >
												<input type="text" name="num_ads" id="num_ads" class="inputbox form-control input-small" size="10" value="2" autocomplete="off"
										...
										<tr>
											...
											<td >
												<div class="controls">
													...
													<label class="radio inline">
														<input type="radio" name="rotate" id="publish2" value="0" checked>
															<?php echo Text::_('JNO');?>
													</label>
												</div>
											</td>
										...
										<tr>
											...
											<td >
												<input type="text" name="rotate_delay" id="rotate_delay" class="inputbox form-control input-small" size="10" value="10" autocomplete="off"
												onkeyup="saAdmin.checkForAlpha(this,46);" />
											</td>
										</tr>
										<tr>
											...
											<td >
												<div class="controls">
													...
													<label class="radio inline">
														<input type="radio" name="rand" id="rand2" value="0" checked>
															<?php echo Text::_('JNO');?>
													</label>
												</div>
											</td>
										...
										<tr>
											...
											<td >
												<div class="input-append">
													<input type="text" name="if_wid" id="if_wid" class="inputbox form-control input-mini" size="10" value="" placeholder="<?php echo Text::_('COM_SOCIALADS_IF_WID_HOLDER');?>" autocomplete="off" />
										...
										<tr>
											...
											<td >
												<div class="input-append">
												<input type="text" name="if_ht" id="if_ht" class="inputbox form-control input-mini" placeholder="<?php echo Text::_('COM_SOCIALADS_IF_HT_HOLDER');?>" size="10" value="" autocomplete="off" />
													<span class="add-on">px</span>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td >
												<div class="controls">
													<label class="radio inline">
														<input type="radio" name="if_seam" id="if_seam1" value="1" >
															<?php echo Text::_('JYES');?>
													</label>
													<label class="radio inline">
														<input type="radio" name="if_seam" id="if_seam2" value="0" checked>
															<?php echo Text::_('JNO');?>
													</label>
												</div>
											</td>
								...
								{ ?>
									<div class="tab-pane fade" id="wtab2" role="tabpanel" aria-labelledby="wtab2-tab">
										<?php
																		...
																		<td>
																			<div class="controls">
																				...
																				if($field->mapping_fieldtype=="gender")
																				{
																					...
																					echo HTMLHelper::_('select.genericlist', $gender, 'mapdata[][' . $field->mapping_fieldname . ',select]', ' class="sa-fields-inputbox form-control" id="mapdata[][' . $field->mapping_fieldname.',select]" size="1"',   'value', 'text', $flds[$field->mapping_fieldname.',select']);
																				}
																				if($field->mapping_fieldtype=="boolean")
																				{
																					...
																					echo HTMLHelper::_('select.genericlist', $boolean, 'mapdata[][' . $field->mapping_fieldname.',select]', ' class="sa-fields-inputbox form-control" id="mapdata[][' . $field->mapping_fieldname.',select]" size="1"',   'value', 'text', $flds[$field->mapping_fieldname.',select']);
																				}
																				/*
																				...
																				*/
																				if($field->mapping_fieldtype=="numericrange")
																				{
																					...
																					if (isset($flds[$field->mapping_fieldname.'_low']) || isset($this->addata_for_adsumary_edit->$lowvar))
																					{
																						...
																						if($zoneid)
																						{
																							...
																							<input type="textbox"  class="sa-fields-inputbox form-control" name="mapdata[][<?php echo $field->mapping_fieldname.'_low|numericrange|0'; ?>]" value="<?php echo $this->addata_for_adsumary_edit->$lowvar; ?>" />
																							<?php echo Text::_('SA_TO'); ?>
																							<input type="textbox" class="sa-fields-inputbox form-control" name="mapdata[][<?php echo $field->mapping_fieldname.'_high|numericrange|1'; ?>]" value="<?php echo $this->addata_for_adsumary_edit->$highvar?>" />
																						<?php
																						}
																						else
																						{
																							...
																							<input type="textbox"  class="sa-fields-inputbox form-control" name="mapdata[][<?php echo $field->mapping_fieldname.'_low|numericrange|0'; ?>]" value="<?php echo $flds[$field->mapping_fieldname.'_low']?>"
																								Onkeyup = "saAdmin.checkForAlpha(this,46);" />
																								<?php echo Text::_('SA_TO'); ?>
																								<input type="textbox" class="sa-fields-inputbox form-control" name="mapdata[][<?php echo $field->mapping_fieldname.'_high|numericrange|1'; ?>]" value="<?php echo $flds[$field->mapping_fieldname.'_high']?>"  Onkeyup = "saAdmin.checkForAlpha(this,46);" />
																						<?php
																						} ?>
																					<?php
																					}
																					...
																					{ ?>
																						<input type="textbox"  class="sa-fields-inputbox form-control" name="mapdata[][<?php echo $field->mapping_fieldname.'_low|numericrange|0'; ?>]" value="" <?php echo $onkeyup; ?> />
																						<?php echo Text::_('SA_TO'); ?>
																						<input type="textbox" class="sa-fields-inputbox form-control" name="mapdata[][<?php echo $field->mapping_fieldname.'_high|numericrange|1'; ?>]" value=""<?php echo $onkeyup; ?> />
																					<?php
																					}
																				} ?>
																				<!--Freetext-->
																				<?php if($field->mapping_fieldtype=="textbox")
																				{
																					...
																					if (isset($flds[$field->mapping_fieldname]) || isset($this->addata_for_adsumary_edit->$textvar))
																					{
																						...
																						{
																						?>
																							<input type="textbox" class="sa-fields-inputbox form-control" name="mapdata[][<?php  echo $field->mapping_fieldname; ?>]" value="<?php echo $this->addata_for_adsumary_edit->$textvar; ?>"  />
																						<?php
																						}
																						else
																						{ ?>
																							<input type="textbox" class="sa-fields-inputbox form-control" name="mapdata[][<?php echo $field->mapping_fieldname; ?>]" value="<?php echo $flds[$field->mapping_fieldname]; ?>" />
																						<?php
																						}
																					}
																					else
																					{?>
																						<input type="textbox" class="sa-fields-inputbox form-control" name="mapdata[][<?php echo $field->mapping_fieldname; ?>]" value="" />
																					<?php
																					}
																				}?>
																				<!--Single Select-->
																					...
																					if($field->mapping_fieldtype=="singleselect")
																					{
																						...
																						if (isset($flds[$field->mapping_fieldname.',select']) || isset($this->addata_for_adsumary_edit->$singlevar))
																						{
																							...
																							if ($zoneid)
																							{
																								...
																								echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $field->mapping_fieldname . ',select]', 'class="sa-fields-inputbox form-control" size="1" ' . $display_reach, 'value', 'text', $mdata);
																							}
																							else
																							{
																								echo HTMLHelper::_('select.genericlist', $options, 'mapdata[]['.$field->mapping_fieldname.',select]', ' class="sa-fields-inputbox form-control"'.$display_reach.' id="mapdata[]['.$field->mapping_fieldname.',select]" size="1"',   'value', 'text', $flds[$field->mapping_fieldname.',select']);
																							}
																						...
																						else
																						{
																							...
																							echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $field->mapping_fieldname . ',select]', 'class="sa-fields-inputbox form-control"  id="mapdata[][' . $field->mapping_fieldname . ',select]" size="1"',   'value', 'text', '');
																							$options= array();
																						}
																					}
																					// Multiselect
																					...
																					if (isset($flds[$field->mapping_fieldname.',select']) || isset($this->addata_for_adsumary_edit->$multivar))
																						{
																							...
																							if($this->edit_ad_adsumary)
																							{
																								...
																								echo HTMLHelper::_('select.genericlist', $options, 'mapdata[]['.$field->mapping_fieldname.',select]', 'class="sa-fields-inputbox form-control inputbox form-control chzn-done" id="mapdata[]['.$field->mapping_fieldname.',select]" size="'.$size.'"  multiple="multiple" ',   'value', 'text', $multidata);
																								$options= array();
																						}
																						else
																						{
																							...
																							{	$size = '6';}
																								...
																								$size = '3';
																							echo HTMLHelper::_('select.genericlist', $options, 'mapdata[]['.$field->mapping_fieldname.',select]', 'class="sa-fields-inputbox form-control  inputbox form-control chzn-done"  size="'.$size.'" id="mapdata[]['.$field->mapping_fieldname.',select]" multiple="multiple"',   'value', 'text', '');
																					...
																					if($field->mapping_fieldtype=="daterange")
																					{
																						...
																						if (isset($flds[$field->mapping_fieldname . '_low']) || isset($this->addata_for_adsumary_edit->$this->datelowvar))
																						{
																							...
																							if ($zoneid)
																							{
																								...
																								echo HTMLHelper::_('calendar', $this->addata_for_adsumary_edit->$this->datelowvar, 'mapdata[][' . $field->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . '][' .$field->mapping_fieldname. '][' . $field->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control input-small'));

																								echo Text::_('COM_SOCIALADS_TO');

																								echo HTMLHelper::_('calendar', $this->addata_for_adsumary_edit->$this->datehighvar, 'mapdata[][' . $field->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' .$field->mapping_fieldname.'][' . $field->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control input-small'));
																							}
																							else
																							{
																								...
																								echo HTMLHelper::_('calendar', $flds[$field->mapping_fieldname . '_low'], 'mapdata[][' . $field->mapping_fieldname . '_low]', 'mapdata[' . $key . '][' .$field->mapping_fieldname. '][' . $field->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control input-small'));
																								echo Text::_('COM_SOCIALADS_TO');
																								echo HTMLHelper::_('calendar', $flds[$field->mapping_fieldname . '_high'], 'mapdata[][' . $field->mapping_fieldname . '_high]', 'mapdata[' . $key . '][' .$field->mapping_fieldname. '][' . $field->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control input-small'));
																							}
																						}
																					else
																					{
																						if ($zoneid)
																						{
																							echo HTMLHelper::_('calendar', '', 'mapdata[][' . $field->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . '][' .$field->mapping_fieldname. '][' . $field->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control','onchange' => 'calculateReach()'));
																							echo Text::_('COM_SOCIALADS_TO');
																							echo HTMLHelper::_('calendar', '', 'mapdata[][' . $field->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' .$field->mapping_fieldname. '][' . $field->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control'));
																						}
																						else
																						{
																							echo HTMLHelper::_('calendar', '', 'mapdata[][' . $field->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . ']['.$field->mapping_fieldname. '][' . $field->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control'));
																							echo Text::_('COM_SOCIALADS_TO');
																							echo HTMLHelper::_('calendar', '', 'mapdata[][' . $field->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . ']['.$field->mapping_fieldname.'][' . $field->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control'));
																						}
																					}
																				...
																				if($field->mapping_fieldtype=="date")
																				{
																					...
																					if(isset($flds[$field->mapping_fieldname]) || isset($this->addata_for_adsumary_edit->$datevar))
																					{
																						if($zoneid)
																						{
																							echo HTMLHelper::_('calendar', $this->addata_for_adsumary_edit->$datevar , 'mapdata[]['.$field->mapping_fieldname.']', 'mapdata[' . $key . ']['.$field->mapping_fieldname.']','%Y-%m-%d', array('class'=>'sa-fields-inputbox form-control'));
																						}
																						else
																						{
																							echo HTMLHelper::_('calendar', $flds[$field->mapping_fieldname] , 'mapdata[]['.$field->mapping_fieldname.']',
																							'mapdata[' . $key . ']['.$field->mapping_fieldname.']','%Y-%m-%d', array('class'=>'sa-fields-inputbox form-control'));
																						}
																					}
																					else
																					{
																						echo HTMLHelper::_('calendar', '', 'mapdata[]['.$field->mapping_fieldname.']', 'mapdata[' . $key . ']['.$field->mapping_fieldname.']','%Y-%m-%d', array('class'=>'sa-fields-inputbox form-control'));
																					} 
																				}?>
