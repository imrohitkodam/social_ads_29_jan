		...
		<div id="filter-bar" class="btn-toolbar">
			<div class="form-inline">
				<div class="filter-search input-group pull-left">
					<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo Text::_('COM_SOCIALADS_COUPONS_FILTER_SEARCH'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo Text::_('COM_SOCIALADS_COUPONS_FILTER_SEARCH'); ?>" />
					...
					<tbody>
						...
						foreach ($this->items as $i => $item) :
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php
								if (isset($this->items[0]->id)): ?>
									<td class="center hidden-phone sa-text-right">
