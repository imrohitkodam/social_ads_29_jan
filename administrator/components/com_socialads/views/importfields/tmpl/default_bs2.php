						...
						foreach ($this->fields as $row)
						{
							...
							<tr class="<?php echo 'row'.$k; ?>" id="<?php echo 'row'.$count; ?>">
								...
								<td id="<?php echo 'row'.$count.'[4]'; ?>" data-title="<?php echo Text::_('COM_SOCIALADS_SOCIAL_TARGETING_MAP_WITH_FIELD_TYPE');?>">
									...
									echo HTMLHelper::_('select.genericlist', $list, 'mappinglist['.$row->id.'][fieldtype]', 'class="input-medium inputbox fieldlist " onchange=saAdmin.importfields.numericRangeCheck(this,'.$row->id.','.$count.'); ' .$disabled, 'value', 'text', $row->mapping_fieldtype); ?>
								</td>
								<?php
							...
							<tr class="<?php echo 'row'.$k; ?>">
								...
								<td colspan="3">
									...
									<div class="sa-imprtfields-controls-inline">
										...
										if ($countbutton == 1)
										{?>
											<input class="sa-imprtfields-controls-left-margin btn btn-small" type = "button" onclick = "saAdmin.importfields.installTargetingPlugins(this);" name = "<?php echo $rowplugin->element;?>" id = "<?php echo $rowplugin->element;?>" value = "<?php echo Text::_('COM_SOCIALADS_SOCIAL_TARGETING_PLGINSTALL_CLK');?>" >
										<?php
										} ?>
