...
<div class="panel panel-default paddingTop1">
		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active">
						<a data-toggle="tab" href="#links"><?php echo Text::_('COM_SA_LINKS'); ?></a>
					</li>
					<li>
						<a data-toggle="tab" href="#tj-dashboard-news"><?php echo Text::_('COM_SOCIALADS_TABS_NEWS'); ?></a>
					</li>
					<li>
						<a data-toggle="tab" href="#about"><?php echo Text::_('COM_SOCIALADS_TABS_ABOUT'); ?></a>
					</li>
				</ul>
