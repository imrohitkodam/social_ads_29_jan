		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-xs-9 text-right">
					<div class="sa-min-h55">
						<h4><?php echo Text::_('COM_SOCIALADS_ALL_TIME_INCOME'); ?></h4>
					</div>
					<div class="huge">
						<?php
						// Print all time income
						$this->price = SaCommonHelper::getFormattedPrice($this->allincome,$this->currency);
						if ($this->price)
						{
							echo $this->price;
						}
	...
	<div class="panel panel-blue-viking">
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-xs-9 text-right">
					<div class="sa-min-h55">
						<h4><?php echo Text::_('COM_SOCIALADS_TOTAL_ADS'); ?></h4>
					</div>
					<div class="huge">
						<?php
						// Print all time income
	...
	<div class="panel panel-purple-blue-marguerita">
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-xs-9 text-right">
					<div class="sa-min-h55">
						<h4><?php echo Text::_('COM_SOCIALADS_AVERAGE_CTR'); ?></h4>
					</div>
					<div class="huge">
						<?php
						// Print average CTR
	...
	<div class="panel panel-green-downy">
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-xs-9 text-right">
					<div class="sa-min-h55">
						<h4><?php echo Text::_('COM_SOCIALADS_TOTAL_ORDERS'); ?></h4>
					</div>
					<div class="huge">
						<?php
						// Print orders count
