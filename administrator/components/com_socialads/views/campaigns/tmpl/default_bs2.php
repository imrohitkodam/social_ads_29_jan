...
<div class="<?php echo SA_WRAPPER_CLASS;?> sa-ad-campagins">
	...
	?>
	<form action="<?php echo Route::_('index.php?option=com_socialads&view=campaigns'); ?>" method="post"
		name="adminForm" id="adminForm">
		<div id="filter-bar" class="btn-toolbar">
			<div class="form-inline">
				<div class="filter-search input-group pull-left">
					<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_FILTER_SEARCH'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_FILTER_SEARCH'); ?>" />
				...
				<?php
				if (JVERSION >= '3.0') : ?>
					<div class="btn-group col-12 col-sm-12 col-md-2 col-lg-1 pull-right me-2">
						<label for="limit" class="element-invisible">
							<?php echo Text::_('JFIELD_PLG_SEARCH_SEARCHLIMIT_DESC');?>
						</label>
						<?php echo $this->pagination->getLimitBox(); ?>
					</div>
					<div class="btn-group col-12 col-sm-12 col-md-2 pull-right me-2">
					<?php
						echo HTMLHelper::_('select.genericlist', $this->createdbyoptions, "filter_usernamelist", 'class="ad-status inputbox input-medium" size="1" onchange="document.adminForm.submit();" name="usernamelist"', "value", "text", $this->state->get('filter.usernamelist'));
					?>
				</div>
				<?php endif; ?>
					<div class="btn-group col-12 col-sm-12 col-md-2 col-lg-1 pull-right me-2">
