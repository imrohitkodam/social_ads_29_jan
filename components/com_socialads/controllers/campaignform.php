...
class SocialadsControllerCampaignForm extends SocialadsController
{
	...
	public function edit()
	{
		...
		$this->setRedirect(Route::_('index.php?option=com_socialads&view=campaignform&id=' . $editId . '&layout=edit', false));
	}
	...
	public function save()
	{
		...
		if ($data === false)
		{
			...
			$this->setRedirect(Route::_('index.php?option=com_socialads&view=campaignform&layout=edit&id=' . $id, false));
		...
		$item = $menu->getActive();
		$url  = 'index.php?option=com_socialads&view=campaigns';
