...
if (empty($order_id))
{
	...
	<div class="well" >
		<div class="alert alert-error">
			<span ><?php echo Text::_('SA_UNABLE_TO_TRACK_ORDER_ID'); ?> </span>
		</div>
	</div>
	<?php
	return false;
...
$selectedGateway = !empty($adDetail['processor']) ? $adDetail['processor'] :(!empty($ad_gateways) ? $ad_gateways[0]->id : '');
		...
		<div class="span6">
			<div id='no-more-tables'>
				<table class="table table-condensed table-bordered">
					<tr>
						<td><?php echo Text::_('COM_SOCIALADS_INVOICE_ID');?></td>
						<td><?php echo (!empty($adDetail['prefix_oid'])?$adDetail['prefix_oid']:$order_id); ?></td>
					</tr>
					<tr>
						<td><?php echo Text::_('COM_SOCIALADS_INVOICE_DATE');?></td>
					...
					?>
					<tr>
						<td><?php echo Text::_('COM_SOCIALADS_BILLIN_VAT_NUM');?></td>
						<td><?php echo $orderDetails->vat_number;?></td>
					</tr>
					<?php } ?>
					<tr>
						<td><?php echo Text::_('COM_SOCIALADS_INVOICE_AMOUNT');?></td>
						<td><?php echo $orderDetails->amount;?></td>
					</tr>
					<tr>
						<td><?php echo Text::_('COM_SOCIALADS_INVOICE_STATUS');?></td>
						<td><?php echo $orderstatus;?></td>
					</tr>
					<tr>
						<td><?php echo Text::_('COM_SOCIALADS_INVOICE_PREPROCESSOR');?></td>
						<td>
							<?php
		...
		<div class="span6">
			...
			{?>
				<div id='no-more-tables'>
					<table class="table table-condensed table-bordered">
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_FNAM');?></td>
							<td><?php echo $billinfo->firstname;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_LNAM');?></td>
						...
						<?php } ?>
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_ADDR');?></td>
							<td><?php echo $billinfo->address;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_ZIP');?></td>
							<td><?php echo $billinfo->zipcode;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_COUNTRY');?></td>
							<td><?php echo $tjGeoHelper->getCountryNameFromId($billinfo->country_code);?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_STATE');?></td>
							<td><?php echo $tjGeoHelper->getRegionNameFromId($billinfo->state_code);?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_CITY');?></td>
							<td><?php echo $billinfo->city;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_PHONE');?></td>
							<td><?php echo $billinfo->phone;?></td>
						</tr>
						<tr>
							<td><?php echo Text::_('COM_SOCIALADS_BILLIN_EMAIL');?></td>
				...
				<div id='no-more-tables'>
					<table class="table table-condensed table-bordered">
						<tr>
							...
							if ($chargeoption	== 0)
							{
								$td_key = Text::_('COM_SOCIALADS_INVOICE_ADMODE_KEY');
							...
							elseif ($chargeoption >= 2)
							{
								...
								{
									$td_key = Text::_('COM_SOCIALADS_INVOICE_ADMODE_KEY');
									$td_value = Text::_('COM_SOCIALADS_ADMODE_DATE_TXT');
								}
						...
						<tr>
							<?php
							$ad_chargeOpKey = Text::_('COM_SOCIALADS_INVOICE_ADMODE_DATE_VALUE');
							$ad_chargeOpValue =  $adTotalDisplay;

							if ($chargeoption < 2)
							{
								$ad_chargeOpKey = Text::_('COM_SOCIALADS_INVOICE_NUM_IMP_OR_CLICKS');
								$ad_chargeOpValue =  $adTotalDisplay;
						...
						{?>
							<?php
							$ad_chargeOpKey = Text::_('COM_SOCIALADS_INVOICE_TOTAL_AMT');
							$ad_chargeOpValue =  $adDetail['original_amount'] .' ' . SaCommonHelper::getCurrencySymbol();
						...
						{ ?>
						<tr>
							<td class=""><?php echo Text::_('COM_SOCIALADS_INVOICE_POINTS');; ?></td>
						...
						<tr id= "" style="">
							<td class=""><?php echo Text::_('COM_SOCIALADS_INVOICE_DIS_COP'); ?></td>
							<td class=""><?php echo  $cop_dis; ?>&nbsp;<?php echo SaCommonHelper::getCurrencySymbol(); ?></td>
						</tr>

						<!-- tax amount -->
						<tr id= "ad_tax" style="">
							<td class=""><?php echo JText::sprintf('COM_SOCIALADS_TAX_AMT');//,$tax[0]); ?></td>
							<td class=""><?php echo $adDetail['tax']; ?>&nbsp;<?php echo SaCommonHelper::getCurrencySymbol();?></td>
						</tr>

						<!-- NET TOTAL AMOUNT after tax and coupon-->
						<tr id= "">
							<td class=""><?php echo Text::_('COM_SOCIALADS_INVOICE_NET_AMT_PAY'); ?></td>
							<td class=""><?php echo $discountedPrice; ?>&nbsp;<?php echo SaCommonHelper::getCurrencySymbol();?>
							</td>
						</tr>
					</table>
				</div>
