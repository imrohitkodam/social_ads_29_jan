...
<div class="<?php echo SA_WRAPPER_CLASS;?>" id="sa-wallet">
	...
	<form action="" method="post" name="adminForm3" id="adminForm3">
		...
		<div class="btn-toolbar wallet_filter form-inline">
			<div class="pull-left btn-group">
				<?php
				echo HTMLHelper::_('select.genericlist', $this->month, 'month', 'name="filter_order" class = "input-small"', "value", "text", $this->lists['month']);
				echo HTMLHelper::_('select.genericlist', $this->year, 'year', 'name="filter_order" class = "input-small"', "value", "text", $this->lists['year']);
				?>
			</div>
			<div class="pull-left btn-group">
		...
		<div>
			<ul class="nav nav-tabs" id="AdWalletTab">
				<li class="active" ><a href="#spent_table" data-toggle="tab"><?php echo Text::_('COM_SOCIALADS_WALLET_ACCOUNT_HISTORY'); ?></a></li>
				<li><a href="#pay_table" data-toggle="tab"><?php echo Text::_('COM_SOCIALADS_WALLET_PAYMENT_CREDTIS_ONLY'); ?></a></li>
			</ul>
		...
		<div class="form-actions" >
			<div class="form-inline row">
				<div class="col-md-4">
					<a href="<?php echo Route::_('index.php?option=com_socialads&view=payment&Itemid='.$this->paymentitemid); ?>" class="btn btn-success"><?php echo Text::_('COM_SOCIALADS_AD_PAYMENT'); ?></a>
				<label title="<?php echo Text::_('COM_SOCIALADS_WALLET_DESC_REDEEM_COUPON'); ?>">
				<?php echo Text::_('COM_SOCIALADS_WALLET_REDEEM_COUPON'); ?></label>
				</div>
				<div class="col-md-2">
					<input id="coupon_code" type="text" class="input-mini form-control" name="coupon" placeholder="code" />					
				</div>
				<div class="col-md-2">
					<input type="button" class="btn btn-primary" id="add_coupon" value="<?php echo Text::_('COM_SOCIALADS_SUBMIT'); ?>" onclick="sa.wallet.applyCouponCode('<?php echo Session::getFormToken(); ?>'); "/>
				</div>
			</div>
		</div>
