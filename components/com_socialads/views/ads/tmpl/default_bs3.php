...
<div class="<?php echo SA_WRAPPER_CLASS;?>" id="sa-ads">
	<form action="" method="post" name="adminForm" id="adminForm">
		...
		<div id="container">
			...
			<div class="col-md-12">
				<div class="row sa-mt-3">
					<div class="col-md-6 col-sm-6 col-6 d-flex  mb-4">
						<div class="form-inline pull-right fromTodateFields">
							<div class="col-md-4 col-sm-4 col-12 float-end ms-2">
				...
				<div class="row sa-mt-6 g-4">
					<?php
						if ($ad_params->get('payment_mode') == 'wallet_mode')
						{
							?>
							<div class="btn-group pull-right hidden-phone social-ads-filter-margin-left float-end col-12 col-sm-12 col-md-2  hidden-phone social-ads-filter-margin-left me-2">
								<?php						
					...
					<div class="btn-group pull-right hidden-phone social-ads-filter-margin-left ms-2 float-end col-12 col-sm-12 col-md-2 col-lg-4 hidden-phone social-ads-filter-margin-left me-2">
					...
					<div class="btn-group pull-right hidden-phone hidden-tablet social-ads-filter-margin-left ms-2 float-end col-12 col-sm-12 col-md-2 col-lg-4 hidden-phone social-ads-filter-margin-left me-2">
						<?php
			...
			?>
						...
						<tbody>
							...
							?>
								<tr class="row<?php echo $i % 2;?>">
									...
									if ($payment_mode == 'pay_per_ad_mode')
									{ ?>
										<td class="center" data-title="<?php echo Text::_('COM_SOCIALADS_PAYMENT_STATUS');?>">
											<?php
									...
									<td class="center actions" data-title="<?php echo Text::_('COM_SOCIALADS_ADS_IGNORES');?>">
										<?php
									...
									<td data-title="<?php echo Text::_('COM_SOCIALADS_ADS_AD_ACTIONS');?>">
										...
										<div class="btn-group actions">
											...
											?>
											<a rel="{handler: 'iframe', size: {x: 900, y: 350}}" title="<?php echo Text::_('COM_SOCIALADS_ADS_PAYMENT_HISTORY'); ?> "  href="<?php echo $paymentHistory; ?>" class="sa-btn-wrapper modal btn btn-mini">
				...
				<div class="alert alert-info">
					<div class="col-lg-4 col-sm-4 sa-legends-padding">
						<div class="col-sm-12">
