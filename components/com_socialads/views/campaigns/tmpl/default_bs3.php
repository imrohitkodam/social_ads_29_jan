	...
	<form action="<?php echo Route::_('index.php?option=com_socialads&view=campaigns&Itemid=' . $this->campaignsItemId); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="filter-bar" class="btn-toolbar">
			<div class="form-inline">
					...
					<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_FILTER_SEARCH'); ?>" 
					value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_FILTER_SEARCH'); ?>" />
			...
			<div class="col-xs-2 col-sm-6 col-md-7 col-lg-7">
				<div class="btn-group col-12 col-sm-12 col-md-2 col-lg-1 pull-right hidden-xs">
					...
					<tbody>
						...
						foreach ($this->items as $i => $item) :
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td class="sa-text-right" data-title="<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_DAILY_BUDGET');?>">
								...
								<td class="sa-text-right" data-title="<?php echo Text::_('COM_SOCIALADS_CAMPAIGNS_NO_OF_ADS');?>">
									<?php
									if ($item->no_of_ads)
									{ ?>
								...
								<td class="sa-text-right" data-title="<?php echo Text::_('COM_SOCIALADS_ADS_AD_TYPE_IMPRS');?>">
									<?php
								...
								<td class="sa-text-right" data-title="<?php echo Text::_('COM_SOCIALADS_ADS_AD_TYPE_C_T_R');?>">
									<?php
									$ctr = 0;
