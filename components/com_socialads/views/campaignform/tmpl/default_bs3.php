...
<div class="<?php echo SA_WRAPPER_CLASS; ?> campaign-edit front-end-edit">
	...
	<div class="form-group row">
		...
		<div class="form-group row">
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 sa-mt-2">
				<button type="submit" class="validate btn  btn-success pull-right ml-18"><?php echo Text::_('JSUBMIT'); ?></button>
				<a class="btn btn-danger pull-right" href="<?php echo Route::_('index.php?option=com_socialads&task=campaignform.cancel'); ?>" title="<?php echo Text::_('JCANCEL'); ?>">
