...
$manageAdsItemId = SaCommonHelper::getSocialadsItemid('ads');
?>
...
<form action="<?php echo Route::_('index.php?option=com_socialads&view=ignores&tmpl=component&Itemid=' . $manageAdsItemId); ?>" method="post" name="adminForm" id="adminForm">
	<h3><?php echo Text::_('COM_SOCIALADS_ADS_IGNORED');?></h3>
	<div id="filter-bar" class="btn-toolbar">
		<div class="col-lg-12 col-md-5 col-sm-6 col-xs-12  ">
			<div class="input-group float-end pull-right">
				<input type="text"
	...
	<table class="table table-striped" id="List">
		<thead>
			...
			<tr>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_SOCIALADS_IGNORES_IGNORED_BY', 'ignored_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<th class='left'>
				<?php
				echo HTMLHelper::_('grid.sort',  'COM_SOCIALADS_IGNORES_AD_FEEDBACK', 'a.ad_feedback', $listDirn, $listOrder); ?>
				</th>
			</tr>
			<?php
			}
