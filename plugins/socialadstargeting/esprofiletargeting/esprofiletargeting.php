 ...
 * @since  1.6
 */
class PlgsocialadstargetingEsprofiletargeting extends CMSPlugin
{
	/**
	...
	public function __construct($subject, $config)
	{
		...
		{
				$this->_plugin = PluginHelper::getPlugin('socialadstargeting', 'esprofiletargeting');
	...
	public function _getLayoutPath($plugin, $group, $layout = 'default')
	{
		...
		$defaultPath = JPATH_SITE . '/plugins/' . $group . '/' . $plugin . '/' . $plugin .
			'/' . $layout . '.php';
