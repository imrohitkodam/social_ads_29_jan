...
if ($addata->ignore != '')
{
	...
	Text::_('COM_SOCIALADS_CLK_IGN') . '" class="ad_ignore_button layout3_ad_ignore_button" src="' .
	Uri::root(true) . '/media/com_sa/images/cross.gif" alt="" onclick="' . $addata->ignore . '" /></span>';
}
