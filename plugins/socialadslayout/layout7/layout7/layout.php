...
if ($addata->ignore != '')
{
	...
	. Text::_('COM_SOCIALADS_CLK_IGN') . '" class="ad_ignore_button layout7_ad_ignore_button" src="' . Uri::root(true)
	. '/media/com_sa/images/cross.gif" alt="" onclick="' . $addata->ignore . '" /></span>';
}

$ht .= '<div class="ad_prev_wrap layout7_ad_prev_wrap">';
...
$ht .= '<!--div for preview ad-image-->
		<div class="layout7_ad_prev_second">';
