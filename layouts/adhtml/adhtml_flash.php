...
<?php SaCommonHelper::loadScriptOnce('media/com_sa/vendors/flowplayer/flowplayer-3.2.13.min.js'); ?>
<?php $ht_wd = 'width:' . $displayData->zone_d->img_width . 'px;height:' . $displayData->zone_d->img_height . 'px'; ?>

	<div
		href="<?php echo Uri::root() . $displayData->ad_image; ?>"
	...
	<script>
		...
		{
			src:"<?php echo Uri::root(true) . '/media/com_sa/vendors/flowplayer/flowplayer-3.2.18.swf'; ?>",
			wmode:"opaque"
		},
		{
			clip : {
			...
			plugins:{
				...
				content: {
					url:"<?php echo Uri::root(true) . '/media/com_sa/vendors/flowplayer/flowplayer.content-3.2.9.swf'; ?>",
...
<?php else: ?>
	...
	<div class="vid_ad_preview"
		href="<?php echo Uri::root() . $displayData->ad_image; ?>"
		style="background:url(<?php echo Uri::root(true) . '/media/com_sa/images/black.png'; ?>);width:<?php echo $displayData->zone_d->img_width; ?>px; height:<?php echo $displayData->zone_d->img_height; ?>px;">
	</div>
