		...
		<div id="context_target_space" class="target_space well">
			<div class="form-group row">
				...
				<div class="controls col-md-8 input-append targetting_yes_no">
					...
					<label class="first btn <?php echo $context_target1_label;?>" type="button" for="context_target1"><?php echo Text::_('JYES');?></label>
					<input type="radio" name="context_targett" id="context_target2" value="0" class="target" <?php echo $context_target2; ?> >
					<label class="last btn <?php echo $context_target2_label;?>" type="button" for="context_target2"><?php echo Text::_('JNO');?></label>
				</div>
			</div>
			...
			<div id="context_targett_div" <?php echo $context_dis; ?> class="targetting">
				...
				<div id="mapping-field-table">
					<div class="form-group row">
						<label class="form-label col-md-4" for="context_target_data" title="<?php echo Text::_('COM_SOCIALADS_AD_CONTEXT_TARGET_INPUTBOX_DESC');?>">
							<?php echo Text::_('COM_SOCIALADS_AD_CONTEXT_TARGET_INPUTBOX');?>
						</label>
						<div class="controls col-md-6">
							<input type="text" name="context_target_data[keywordtargeting]" class="inputbox form-control input-xlarge" id="context_target_data" value="<?php echo $displayData->context_target_data_keywordtargeting;?>" onchange="" />
						</div>
					</div>
				</div>
			</div>
