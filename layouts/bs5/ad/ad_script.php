...
<script type="text/javascript">
	...
	var selected_layout="<?php echo (!empty($displayData->addata_for_adsumary_edit->layout) ? htmlspecialchars($displayData->addata_for_adsumary_edit->layout, ENT_COMPAT, 'UTF-8') : ''); ?>";
	...
	var minimumBalence="<?php echo Text::sprintf('COM_SOCIALADS_AD_ALLOWED_BUDGET', $displayData->sa_params->get('min_pre_balance'), $displayData->sa_params->get('currency'));?>";
