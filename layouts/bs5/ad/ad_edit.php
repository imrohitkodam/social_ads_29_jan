...
<div class="techjoomla-bootstrap tjBs5" id="sa_create">
	<!--row row-fluid-->
	<div class="row row-fluid">
		<!-- main div starts here-->
		<div class="sa-form">
			<div class="fuelux wizard-example">
				<div class="sa_steps_parent row row-fluid">
					<!--wizard-->
					...
					onsubmit="return validateForm();">
						...
						<div class="tab-pane step-pane active" id="step1">
							<?php
								...
								if ($isAdmin == 1)
								{
									$saLayout = new FileLayout('bs5.ad.ad_design');
								}
								else
								{
									$saLayout = new FileLayout('ad.ad_design');
								}
						...
						if ($displayData->showTargeting == 1)
						{
							...
							<div class="tab-pane step-pane " id="step2">
								...
								if ($isAdmin == 1)
								{
									$saLayout = new FileLayout('bs5.ad.ad_targeting');
								}
								else
								{
									$saLayout = new FileLayout('ad.ad_targeting');
								}
						...
						<div class="tab-pane step-pane" id="step3">
							...
							if ($paymentMode == 'pay_per_ad_mode')
							{
								if ($isAdmin == 1)
								{
									$saLayout = new FileLayout('bs5.ad.ad_pricing');
								}
								else
								{
									$saLayout = new FileLayout('ad.ad_pricing');
								}
							...
							else
							{
								if ($isAdmin == 1)
								{
									$saLayout = new FileLayout('bs5.ad.ad_camp');
								}
								else
								{
									$saLayout = new FileLayout('ad.ad_camp');
								}
						...
						<form method="post" name="sa_BillForm" id="sa_BillForm" class="form-horizontal form-validate" onsubmit="return validateForm();">
							<div class="tab-pane step-pane sa_build_ad_billing" id="step<?php echo $sa_stpeNo; ?>">
								<?php
									if ($isAdmin == 1)
									{
										$saLayout = new FileLayout('bs5.ad.ad_billing');
									}
									else
									{
										$saLayout = new FileLayout('ad.ad_billing');
									}
				...
				<!--float-end-->
				<div class="prev_next_wizard_actions mt-2">
					<div class="form-actions">
						...
						<button id="btnWizardNext" type="button" class="btn btn-primary float-end" data-last="Finish" >
...
$saLayout = new FileLayout('ad_script', $basePath = JPATH_ROOT . '/layouts/bs5/ad');
echo $saLayout->render($displayData);
