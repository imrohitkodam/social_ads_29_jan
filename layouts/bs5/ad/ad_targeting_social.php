						...
						<div id="floatmain" >
							<div id="mapping-field-table">
								...
								foreach ($displayData->fields as $key => $fields)
								{
									...
									{ ?>
										<div class="row">
											<div class="form-group row col-md-9 row">
												<label class="ad-fields-lable col-md-4">
													<?php
												...
												<div class="controls col-md-8">
													...
													if ($fields->mapping_fieldtype == "gender")
													{
														...
														' class="sa-fields-inputbox form-select chzn-done" id="mapdata[][' . $fields->mapping_fieldname . ',select]" size="1"',
													...
													*/
													...
													if ($fields->mapping_fieldtype == "multiselect" )
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . ',select']) || isset($displayData->addata_for_adsumary_edit->$multivar))
														{
															...
															echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', 'class="sa-fields-inputbox form-select chzn-done" id="mapdata[][' . $fields->mapping_fieldname . ',select]" size="' . $size . '" multiple="true"' . $displayReachCount, 'value', 'text', $multidata);
														...
														else
														{
															...
															echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', 'class="sa-fields-inputbox form-select chzn-done" size="' . $size . '" id="mapdata[][' . $fields->mapping_fieldname . ',select]" multiple="true"' . $displayReachCount, 'value', 'text', '');
													...
													if ($fields->mapping_fieldtype == "daterange")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . '_low']) || isset($displayData->addata_for_adsumary_edit->$datelowvar))
														{
															...
															if ($displayData->edit_ad_id)
															{
																...
																echo HTMLHelper::_('calendar', $displayData->addata_for_adsumary_edit->$datelowvar, 'mapdata[][' . $fields->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control input-small', $displayReachFunction));

																echo Text::_('COM_SOCIALADS_TO');

																echo HTMLHelper::_('calendar', $displayData->addata_for_adsumary_edit->$datehighvar, 'mapdata[][' . $fields->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control input-small', $displayReachFunction));
															}
																else
																{
																	...
																	echo HTMLHelper::_('calendar', $displayData->flds[$fields->mapping_fieldname . '_low'], 'mapdata[][' . $fields->mapping_fieldname . '_low]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control input-small', $displayReachFunction));
																	echo Text::_('COM_SOCIALADS_TO');
																	echo HTMLHelper::_('calendar', $displayData->flds[$fields->mapping_fieldname . '_high'], 'mapdata[][' . $fields->mapping_fieldname . '_high]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control input-small', $displayReachFunction));
																}
														}
														else
														{
															if ($displayData->edit_ad_id)
															{
																	...
																	echo Text::_('COM_SOCIALADS_TO');
																	echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control', $displayReachFunction));
															}
															else
															{
																	echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control', $displayReachFunction));
																	echo Text::_('COM_SOCIALADS_TO');
																	echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control', $displayReachFunction));
															}
														}
													...
													if ($fields->mapping_fieldtype == "date")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname]) || isset($displayData->addata_for_adsumary_edit->$datevar))
														{
															if ($displayData->edit_ad_id)
															{
																echo HTMLHelper::_('calendar', $displayData->addata_for_adsumary_edit->$datevar, 'mapdata[][' . $fields->mapping_fieldname . ']', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . ']', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control', $displayReachFunction));
															}
															else
															{
																echo HTMLHelper::_('calendar', $displayData->flds[$fields->mapping_fieldname], 'mapdata[][' . $fields->mapping_fieldname . ']', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . ']', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control', $displayReachFunction));
															}
														}
														else
														{
															echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . ']', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . ']', '%Y-%m-%d', array('class' => 'sa-fields-inputbox form-control', $displayReachFunction));
														}
													}
													?>
												</div>
