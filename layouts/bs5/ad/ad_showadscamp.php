	...
	<form action="" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="" >
		<fieldset class="sa-fieldset">
			...
			<div class=" row show-grid">
				<!--ad detai start -->
				<div class="col-md-6 sa-overflow-x">
		...
		<div class="form-actions">
			...
			<button id="buy" type="button" class="btn me-2 float-end btn-success" onclick="Joomla.submitform('create.activateAd')">
				<?php echo Text::_('COM_SOCIALADS_SAVE_ACTIVATE');?>
			</button>
			<button id="draft" type="button" class="btn me-2 float-end btn-info" onclick="Joomla.submitform('create.draftAd');">
				<?php echo Text::_('COM_SOCIALADS_SHOWAD_DRAFT');?>
			</button>
			<button id="sa_cancel" type="button" class="btn btn-default btn-danger me-2 float-end" style="margin-right:1%;" onclick="sa.create.cancelCreate()">
