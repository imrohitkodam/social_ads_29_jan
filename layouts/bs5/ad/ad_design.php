...
<div class="sa-create" id="sa-create-id">
	<div class="row">
		<fieldset class="sa-fieldset">
			...
			<div class="row">
				<div class="col-md-6 sa-border-right">
					<div class="row">
						<!-- ad-info start here -->
						<div class="sa-info col-md-11">
							<div id="default_zone" >
								<?php
								...
								?>
									<div class="control-group form-group ">
										<label for="ad_creator_name" class="form-label">
											<?php
								...
								{
								?>
									<input type="hidden" id="ad_creator_id" name="ad_creator_id" class="required form-control"
									...
									<div class="controls">
										...
										?>
											...
											echo HTMLHelper::_('select.genericlist', $displayData->ad_types, "adtype",
												'class="ad-type form-select chzn-done input-medium" size="1" onchange="sa.create.changeAdType()"',
										...
										?>
											<input type="text" id="adtype" name="adtype" class="form-control" value="<?php echo $displayData->ad_type; ?>" readonly="readOnly"  />
										<?php
										}
										?>
									</div>
								...
								<div class="control-group form-group">
									<label for="adzone" class="form-label">
										<?php
										echo HTMLHelper::tooltip(
											Text::_('COM_SOCIALADS_ADZONE_DESC'), Text::_('COM_SOCIALADS_ADZONE'),
											'', '* ' . JText::_('COM_SOCIALADS_ADZONE')
										);
										?>
									</label>
									<div class="controls">
										<select size="1" class="chzn-done form-select input-medium" id="zone" name="adzone" onchange="sa.create.getZonesData( <?php $paymentMode; ?>)"
								...
								<div class="control-group form-group">
									...
									<div class="controls">
										<select name="display_ad_on[]" id="display_ad_on" class="form-select" multiple="multiple">
											<?php
							...
							<div id="defaulturl">
								...
								?>
								<div class="control-group form-group" id="destination_url"  style="<?php echo $display_dest; ?>">
									<label for="url2">
									...
									<div id="defaulturl1">
										...
										<div class="" id="sa-form-spantxt">
											<div id="enterlink" class="form-inline">
												<?php echo HTMLHelper::_(
													'select.genericlist',  $displayData->ad_url, 'addata[ad_url1]',
													'class="inputbox form-select input-mini"', 'value', 'text',
													htmlspecialchars($displayData->url1_edit, ENT_COMPAT, 'UTF-8')
												); ?>
												<input class="inputbox form-control url sa-md-w-75" type="text" id="url2" name="addata[ad_url2]"
										...
										else
										{
											...
											?>
												<!--selectlink-->
												<div class="control-group form-group show-filed" id="selectlink">
								...
								<!--div.control-group form-group#defaulturl-->
								<?php
								if ($promotion_plugins == 1)
								{
								...
								?>
								<!--promotplugin-->
								<div id="promotplugin" class="promotplugin control-group form-group" style="<?php echo $display_td; ?>">
									<div id="contentlable">
							...
							<div class="control-group form-group" id='ad_title_name'>
								<label for="ad_title">
									<?php echo HTMLHelper::tooltip(
								...
								<div class="controls" id='ad_title_box'>
									<input class="inputbox form-control" type="text" id="ad_title"
							...
							<!--div.control-group form-group#ad_title_name-->
							<div class="control-group form-group" id='ad_body_name'>
								<label for="ad_body">
									<?php echo HTMLHelper::tooltip(
								...
								<div class="controls" id='ad_body_box'>
									<textarea id="body" name="addata[ad_body]" rows="3" class="form-control"
							...
							<!--div.control-group form-group#ad_body_name-->
							<!-- image upload-->
							<div class="control-group form-group" id='ad_img_name'>
								...
								<div class="controls" id='ad_img_box'>
									...
									<span id="direct_upload">
										<div class="input-append">
											...
											<div class="mb-3">
												<label for="ad_image" class="form-label"><?php echo Text::_('COM_SOCIALADS_AD_SELECT_FILE');?></label>
												<input class="form-control" type="file" name="ad_image" id="ad_image" value="<?php echo htmlspecialchars($displayData->ad_image, ENT_COMPAT, 'UTF-8'); ?>" onchange="ajaxUpload(this.form,'&filename=ad_image','upload_area','<?php echo Text::_('COM_SOCIALADS_AD_IMG_WAIT');?><img src=\'<?php echo Uri::root(true);?>/media/com_sa/images/loader_light_blue.gif\' width=\'128\' height=\'15\' border=\'0\' />','<img src=\'<?php echo Uri::root(true);?>/media/com_sa/images/error.gif\' width=\'16\' height=\'16\' border=\'0\' /> <?php echo Text::_('COM_SOCIALADS_AD_IMG_ERR_MSG');?>'); return false;">
											</div>
											<div class="clearfix"></div>
										</div>
										<div class="m-5 alert alert-info msg_support_type alert-help-inline">
							...
							<!--div.control-group form-group#ad_img_name-->
							<!-- image upload-->
							...
							if ($displayData->special_access)
							{
								...
								<div class="control-group form-group">
									<div class="form-check">
										<input class="form-check-input" name="altadbutton" type="checkbox" id="altadbutton" onclick="sa.create.switchCheckboxalt(
										this, guestbutton ,'<?php echo Text::_("COM_SOCIALADS_BTN_SAVEANDNEXT");?>',
										'<?php echo Text::_("COM_SOCIALADS_BTN_SAVEANDEXIT");?>'
										)"  <?php echo $checked; ?>>
										<label class="form-check-label" for="altadbutton">
										<?php echo Text::_("COM_SOCIALADS_ALT_AD") ?>
										</label>
									</div>
								</div>
								<div class="alert alert-info alert-help-inline m-5 mt-2">
							...
							<div class="control-group form-group" <?php echo $guest_dis; ?>>
								<?php
							...
							<div id="sa_ad_more_credit_radio" class="control-group form-group" <?php echo $displayData->addMoreCredit ? "":"style='display:none'"; ?>>
								...
								?>
									...
									<div class="checkbox-inline">
										...
										<label for="sa_accpt_terms" style="float:left; margin-top: -2px;">
											...
											<a data-bs-toggle="modal" class="link-primary" data-bs-target="#TermsAndConditionModal">
				...
				<div class="col-md-6">
					<div class="form-horizontal">
						<!--preview-->
						<div class="preview bs5-ad-preview" >
							<!--start for layouts-->
							<div id="layout_div" class="control-group form-group">
