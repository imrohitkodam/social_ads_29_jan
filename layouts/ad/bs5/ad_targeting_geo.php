			...
			if ($displayData->geodbfile_exists)
			{
				...
				<div id="mapping-field-table">
					<div class="form-group col-md-8 row">
						<label class="col-md-4" label-default for="" title="<?php echo Text::_('COM_SOCIALADS_AD_GEO_COUNTRY');?>">
					...
					<div class="form-group row">
						<div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
							<div id ="geo_others" style="display:none;">
								<label label-default class="saradiolabel label-default radio col-md-4" for="everywhere"><input type="radio"
								...
								<div class="mt-3 row" <?php echo in_array('byregion', $displayData->sa_params->get('geo_options')) ? '' :'style="display:none;"'; ?> >
									<label label-default class="saradiolabel label-default radio col-md-4" for="byregion">
										<input type="radio"
								...
								<div class="mt-3 row" <?php echo in_array('bycity', $displayData->sa_params->get('geo_options')) ? '' : 'style="display:none;"'; ?>>
									<label label-default class="saradiolabel label-default radio col-md-4" for="bycity">
										<input type="radio"
