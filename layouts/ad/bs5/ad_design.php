...
<div class="sa-create" id="sa-create-id">
	<div class="row pt-1">
		<fieldset class="sa-fieldset">
			<legend class="hidden-md hidden-lg mt-xs-5 fw-bold bg-info bg-opacity-100 text-light p-2 rounded-2">
				<?php echo Text::_('COM_SOCIALADS_DESIGN');?>
			</legend>
			<div class="row pt-4">
				<div class="col-sm-6 col-md-6 col-xs-12 sa-border-right px-3">
					<div class="row">
						<!-- sa-info start here -->
						<div class="sa-info col-lg-11 col-md-11 col-sm-11 col-xs-11">
							<div id="default_zone" >
									...
									<div>
										...
										?>
											<?php echo HTMLHelper::_(
												...
												'class="ad-type form-select chzn-done" size="1" onchange="sa.create.changeAdType()"',
								...
								<div class="form-group">
									...
									<div>
										<select size="1" class="chzn-done form-select" id="zone" name="adzone" onchange="sa.create.getZonesData( <?php $paymentMode; ?>)"
								...
								<div class="form-group" id="destination_url"  style="<?php echo $display_dest; ?>">
									...
									<div id="defaulturl1">
										...
										<div class="" id="sa-form-spantxt">
											<div id="enterlink" class="form-inline input-group">
												<?php echo HTMLHelper::_(
												...
												<input class="inputbox form-control url" type="text" id="url2" name="addata[ad_url2]"
							...
							<div class="form-group" id='ad_title_name'>
								...
								<div id='ad_title_box'>
									<input class="inputbox form-control" type="text" id="ad_title" class="form-control" value="<?php echo htmlspecialchars($displayData->ad_title_edit, ENT_COMPAT, 'UTF-8'); ?>"
							...
							<div class="form-group" id='ad_body_name'>
								...
								<div id='ad_body_box'>
									<textarea class="inputbox form-control" id="body" name="addata[ad_body]" rows="3"
							...
							<div class="form-group" id='ad_img_name'>
								...
								<div id='ad_img_box'>
									...
									<span id="direct_upload">
										...
										<div class="alert alert-info msg_support_type alert-help-inline me-5">
							...
							if ($displayData->special_access)
							{
								...
								<div class="form-group">
									...
									<div class="alert alert-info alert-help-inline me-5 mt-2">
				...
				<div class="col-sm-6 col-md-6 col-xs-12 px-3">
