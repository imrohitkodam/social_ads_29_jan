...
<div id="lowerdiv" style="display:block;">
	<fieldset class="sa-fieldset">
		<legend class="hidden-md hidden-lg"><?php echo Text::_('COM_SOCIALADS_AD_TARGETING'); ?></legend>
		<div class="alert">
			<i><?php echo Text::_('COM_SOCIALADS_AD_TARGETING_DESC');?> </i>
		</div>
		<!-- geo target start here -->
		<?php
		$saLayout = new FileLayout('ad.bs5.ad_targeting_geo');
		...
		<?php
		$saLayout = new FileLayout('ad.bs5.ad_targeting_social');
		...
		<?php
		$saLayout = new FileLayout('ad.bs5.ad_targeting_contextual');
