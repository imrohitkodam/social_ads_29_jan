		...
		<div id="social_target_space" class="target_space well">
			<div class="form-group row">
				<label label-default class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
					...
					Text::_('COM_SOCIALADS_AD_SOCIAL_TARGETING_DESC'),
					Text::_('COM_SOCIALADS_AD_SOCIAL_TARGETING'),
					'', Text::_('COM_SOCIALADS_AD_SOCIAL_TARGETING')
					); ?>
				</label>
				<div class="col-lg-9 col-md-9 col-sm-8 col-xs-6 input-append targetting_yes_no">
			...
			<div id="social_targett_div" <?php echo $social_dis; ?> class="targetting">
				<div class="alert alert-info mt-2">
					<i id="sa-form-span">
						...
						{
							echo Text::_('COM_SOCIALADS_AD_TARGET_NOT_SET');
						}
						else
						{
							echo Text::_('COM_SOCIALADS_AD_TARGET_MESSAGE1');
							?>
							<br/>
							<?php
							echo Text::_('COM_SOCIALADS_AD_TARGET_MESSAGE2');
							?>
							<?php
						}
						?>
					...
					<div id="field_target">
						...
						<div id="floatmain" >
							<div id="mapping-field-table">
									...
									{ ?>
										<div class="row">
											<div class="form-group col-md-9 row">
												<label label-default class="ad-fields-lable col-lg-4 col-md-4 col-sm-4 col-xs-12">
													<?php
													...
													{
														$fields->mapping_label = Text::_("$fields->mapping_label");
													}
												...
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
													...
													if ($fields->mapping_fieldtype == "gender")
													{
														...
														$gender[] = HTMLHelper::_('select.option', '2', Text::_("COM_SOCIALADS_AD_TARGET_FEMALE"));
														$gender[] = HTMLHelper::_('select.option', '1', Text::_("COM_SOCIALADS_AD_TARGET_MALE"));

														echo HTMLHelper::_(
														'select.genericlist', $gender, 'mapdata[][' . $fields->mapping_fieldname . ',select]',
														' class="sa-fields-inputbox chzn-done form-select" id="mapdata[][' . $fields->mapping_fieldname . ',select]" size="1"',
													...
													if ($fields->mapping_fieldtype == "boolean")
													{
														...
														$boolean[] = HTMLHelper::_('select.option', '1', Text::_("JYES"));
														$boolean[] = HTMLHelper::_('select.option', '0', Text::_("JNO"));

														echo HTMLHelper::_('select.genericlist', $boolean,
													...
													*/
													...
													if ($fields->mapping_fieldtype == "numericrange")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . '_low']) || isset($displayData->addata_for_adsumary_edit->$lowvar))
														{
															...
															if ($displayData->edit_ad_id)
															{
																...
																<input type="textbox" class="sa-fields-inputbox input-small form-control"
																...
																<?php echo Text::_('COM_SOCIALADS_TO'); ?>
														...
														{
															?>
															<input type="textbox"  class="sa-fields-inputbox input-small form-control" name="mapdata[][<?php echo $fields->mapping_fieldname . '_low|numericrange|0'; ?>]"
																value=""
																<?php echo $displayReachCount; ?>
																<?php echo $onkeyup; ?> />
															...
															<input type="textbox" class="sa-fields-inputbox input-small form-control" name="mapdata[][<?php echo $fields->mapping_fieldname . '_high|numericrange|1'; ?>]"
													...
													if ($fields->mapping_fieldtype == "singleselect")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . ',select']) || isset($displayData->addata_for_adsumary_edit->$singlevar))
														{
															...
															if ($displayData->edit_ad_id)
															{
																...
																echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', 'class="sa-fields-inputbox form-select chzn-done" size="1" ' . $displayReachCount, 'value', 'text', $mdata);
															}
															else
															{
																echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', ' class="sa-fields-inputbox form-select chzn-done"' . $displayReachCount . ' id="mapdata[][' . $fields->mapping_fieldname . ',select]" size="1"', 'value', 'text', $displayData->flds[$fields->mapping_fieldname . ',select']);
															}
														...
														else
														{
															...
															echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', 'class="sa-fields-inputbox form-select chzn-done"  id="mapdata[][' . $fields->mapping_fieldname . ',select]"' . $displayReachCount . ' size="1"', 'value', 'text', '');
													...
													if ($fields->mapping_fieldtype == "multiselect" )
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . ',select']) || isset($displayData->addata_for_adsumary_edit->$multivar))
														{
															...
															echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', 'class="sa-fields-inputbox chzn-done form-select" id="mapdata[][' . $fields->mapping_fieldname . ',select]" size="' . $size . '" multiple="true"' . $displayReachCount, 'value', 'text', $multidata);
														...
														else
														{
															...
															echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', 'class="sa-fields-inputbox chzn-done form-select" size="' . $size . '" id="mapdata[][' . $fields->mapping_fieldname . ',select]" multiple="true"' . $displayReachCount, 'value', 'text', '');
													...
													if ($fields->mapping_fieldtype == "daterange")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . '_low']) || isset($displayData->addata_for_adsumary_edit->$datelowvar))
														{
															...
															if ($displayData->edit_ad_id)
															{
																...
																echo HTMLHelper::_('calendar', $displayData->addata_for_adsumary_edit->$datelowvar, 'mapdata[][' . $fields->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox input-small form-control', $displayReachFunction));

																echo Text::_('COM_SOCIALADS_TO');

																echo HTMLHelper::_('calendar', $displayData->addata_for_adsumary_edit->$datehighvar, 'mapdata[][' . $fields->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox input-small form-control', $displayReachFunction));
															}
																else
																{
																	...
																	echo HTMLHelper::_('calendar', $displayData->flds[$fields->mapping_fieldname . '_low'], 'mapdata[][' . $fields->mapping_fieldname . '_low]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox input-small form-control', $displayReachFunction));
																	echo Text::_('COM_SOCIALADS_TO');
																	echo HTMLHelper::_('calendar', $displayData->flds[$fields->mapping_fieldname . '_high'], 'mapdata[][' . $fields->mapping_fieldname . '_high]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox input-small form-control', $displayReachFunction));
																}
														}
														else
														{
															if ($displayData->edit_ad_id)
															{
																	echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox','onchange' => 'sa.create.calculateReach()'));
																	echo Text::_('COM_SOCIALADS_TO');
																	echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox', $displayReachFunction));
															}
															else
															{
																	echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox', $displayReachFunction));
																	echo Text::_('COM_SOCIALADS_TO');
																	echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox', $displayReachFunction));
															}
														}
													...
													if ($fields->mapping_fieldtype == "date")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname]) || isset($displayData->addata_for_adsumary_edit->$datevar))
														{
															if ($displayData->edit_ad_id)
															{
																echo HTMLHelper::_('calendar', $displayData->addata_for_adsumary_edit->$datevar, 'mapdata[][' . $fields->mapping_fieldname . ']', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . ']', '%Y-%m-%d', array('class' => 'sa-fields-inputbox', $displayReachFunction));
															}
															else
															{
																echo HTMLHelper::_('calendar', $displayData->flds[$fields->mapping_fieldname], 'mapdata[][' . $fields->mapping_fieldname . ']', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . ']', '%Y-%m-%d', array('class' => 'sa-fields-inputbox', $displayReachFunction));
															}
														}
														else
														{
															echo HTMLHelper::_('calendar', '', 'mapdata[][' . $fields->mapping_fieldname . ']', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . ']', '%Y-%m-%d', array('class' => 'sa-fields-inputbox', $displayReachFunction));
														}
													}
													?>
												</div>
								...
								// $results = Factory::getApplication()->triggerEvent('onFrontendTargetingDisplay', array($adid, $displayData->adfieldsTableColumn));

								// $results = Factory::getApplication()->triggerEvent('onFrontendTargetingDisplay', array($displayData->edit_ad_id, $displayData->adfieldsTableColumn));

								if (isset($displayData->addata_for_adsumary_edit))
								{
									$results = Factory::getApplication()->triggerEvent(
										'onFrontendTargetingDisplay',
										array(
											$displayData->addata_for_adsumary_edit,
											$displayData->adfieldsTableColumn
										)
									);
								}
