			...
			<div class="container-fluid">
				...
				<div class="form-group row" id="priceperdate" style="<?php echo $display_style; ?>">
					...
					else
					{
						...
						$startDate = (isset($displayData->addata_for_adsumary_edit) && $displayData->addata_for_adsumary_edit && $displayData->addata_for_adsumary_edit->ad_startdate) ? $displayData->addata_for_adsumary_edit->ad_startdate : '';
										//echo "=====2=====";
						?>
							...
							<div class="ad-price-lable col-lg-9 col-md-9 col-sm-6 col-xs-6">
								...
								{
								    echo HTMLHelper::_("calendar", " ", "datefrom", "datefrom", "%Y-%m-%d", 'class="ad-pricing", onchange="sa.create.calculateTotal()"');
								}
								?>
								<!--
								<div id="sa_recuring_div" style="display:none">
				...
				if (isset($ad_chargeoption) && $ad_chargeoption == 2 && $displayData->addata_for_adsumary_edit && $displayData->addata_for_adsumary_edit->ad_enddate)
				{
					...
					<div class="form-group row">
						...
						<label class="ad-price-lable form-label col-lg-3 col-md-3 col-sm-6 col-xs-6" width="40%">
						...
						<div class="ad-price-lable col-lg-9 col-md-9 col-sm-6 col-xs-6">
							<input type="text" class="form-control" readonly value="<?php echo $displayData->addata_for_adsumary_edit->ad_enddate; ?>">
						</div>
				...
				elseif ((count($pricing_options)==1 && $pricing_options[0] == 'perday'))
				{
					$date_dis = 'display:block';
				}
				else
				...
				<?php
				if ($ad_chargeoption == 2 || (count($pricing_options))==1 && $pricing_options[0] == 'perday')
				{ ?>
				...
				{ ?>
					<div id="priceperclick" class = "form-group row" style="display:block">
				<?php
				} ?>
						<label label-default class="ad-price-lable col-lg-3 col-md-3 col-sm-4 col-xs-12">
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
							<input type="text" maxlength="10" name="totaldisplay" class="ad-pricing input-medium cal_text form-control" id="totaldisplay" value="<?php echo $ad_totaldisplay; ?>" onchange="sa.create.calculateTotal()"  />
						</div>
					</div>
					...
					{ ?>
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
							...
							<span id="gateway_div" <?php echo $gateway_style; ?>>
								...
								'class="ad-pricing form-select" size="1" onchange="sa.create.calculatePoints()" ', "value",
								"text", $ad_gateway
								); ?>
							</span>
						</div>
				...
				<div class="sa_hideForUnlimitedads" >
					<div class="form-group row " >
						...
						<div class="form-group row" >
							<label label-default class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
							</label>
							<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
								<div id="sa_cop_tr"  style="display:none;" class="col-sm-offset-3 col-sm-9 form-inline input-group">
									...
									<input type="button" class="btn btn-default btn-success" onclick="sa.create.applyCoupon(1, '<?php echo Session::getFormToken(); ?>')"
					...
					<div class="form-group row sa_cop_details " style="display:none;" >
						<label label-default class="col-lg-3 col-md-3 col-sm-4 col-xs-12"><?php echo Text::_("COM_SOCIALADS_COUPON_PRICE") ?></label>
							<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" id="sa_cop_afterprice">
							</div>
					</div>

					<div class="form-group row sa_cop_details " style="display:none;" >
						<label label-default class="col-lg-3 col-md-3 col-sm-4 col-xs-12"> <?php echo Text::_("COM_SOCIALADS_AFTER_COUPON_PRICE") ?></label>
