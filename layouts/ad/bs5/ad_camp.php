		...
		<div class="form-horizontal">
			...
			<div class="form-group row">
				...
				if ($displayData->unlimited_ad_create_access)
				{
					...
					<div id="review" class="col-lg-9 col-md-9 col-sm-8 col-xs-12 unlimited_yes_no">
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 form-inline">
					<?php
					echo HTMLHelper::_('select.genericlist', $campaignOptions, "ad_campaign", 'class="chzn-done form-select" onchange="sa.create.hideNewCampaign(); showCampaignDetails(this.value)"', "value", "text", $displayData->camp_id);

					if (empty($displayData->cname))
					{
						?>
						<button type="button" class="btn btn-default newCampBtnText btn-primary" onclick="sa.create.showNewCamp();"><?php echo HTMLHelper::tooltip(Text::_('COM_SOCIALADS_CREATE_CAMP_TOOLTIP'), Text::_('COM_SOCIALADS_NEW'), '', Text::_('COM_SOCIALADS_NEW')); ?></button>
			...
			<div class="form-group row">
				<label label-default class="col-lg-3 col-md-3 col-sm-4 col-xs-12" for=""></label>
				<div class="campaign-details col-lg-9 col-md-9 col-sm-8 col-xs-12 form-inline" id="campaignDetails">
					<?php
			...
			<div id="new_campaign" class="form-group row <?php echo $show_new_campaign_box; ?>">
				...
				<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
					<div class="form-inline row ms-2">
						<div class="col-md-4">
							<input type="text" class="input-small form-control col-md-6" id="camp_name" name="camp_name" placeholder="<?php echo JText::_('COM_SOCIALADS_ENTER_CAMPAIGN_NAME'); ?>" title="<?php echo JText::_('COM_SOCIALADS_ENTER_CAMPAIGN_NAME'); ?>" value="<?php // echo $displayData->cname; ?>">
						</div>
						<div class="col-md-4">
			...
			<div class="form-group row">
				...
				<div class="col-lg-6	 col-md-6 col-sm-8 col-xs-12">
					<?php echo HTMLHelper::_('select.genericlist', $pricingOptions, "pricing_opt", 'class="chzn-done form-select"  onchange="sa.create.getZonePricing()"', "value", "text", $displayData->ad_payment_type); ?>
				</div>
