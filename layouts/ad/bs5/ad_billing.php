	...
	<div class="container-fluid">
		<div id="ads_mainwrapper" class="row form-horizontal">
			...
			<div class="form-group row">
				...
				<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
					...
					echo $displayData->dropdown = HTMLHelper::_(
						...
						'class=" ads_ckout_select form-select bill required" required="true" aria-invalid="false" size="1"
			...
			<div class="form-group row">
				...
				<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
					<input id="city" class="input-medium bill inputbox form-control required validate-name" type="text"
