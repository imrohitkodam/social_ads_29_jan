	...
	<div class="form-horizontal">
		<form action="" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="" >
			<fieldset class="sa-fieldset">
				<legend class="hidden-md hidden-lg"><?php echo Text::_('COM_SOCIALADS_REVIEW_AD_TAB'); ?></legend>
			...
			<div class="form-actions">
				<button id="btnWizardPrev" type="button" class="btn btn-default btn-primary pull-left" onclick="techjoomla.jQuery('#MyWizard').wizard('previous');">
					<span class="glyphicon glyphicon-circle-arrow-left" aria-hidden="true"></span> <?php echo Text::_('COM_SOCIALADS_PREV'); ?>
				</button>
				<button id="buy" type="button" class="btn btn-default btn-success pull-right" style="margin-right:1%;" onclick="Joomla.submitform('create.activateAd')">
					<?php echo Text::_('COM_SOCIALADS_SAVE_ACTIVATE');?>
				</button>
				<button id="draft" type="button" class="btn btn-default btn-info pull-right" style="margin-right:1%;" onclick="Joomla.submitform('create.draftAd');">
