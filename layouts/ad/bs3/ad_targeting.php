...
<div id="lowerdiv" style="display:block;">
	<fieldset class="sa-fieldset mt-sm-3 mt-xs-5">
		...
		<?php
		$saLayout = new FileLayout('ad.bs3.ad_targeting_geo');
		...
		<?php
		$saLayout = new FileLayout('ad.bs3.ad_targeting_social');
		...
		<?php
		$saLayout = new FileLayout('ad.bs3.ad_targeting_contextual');
