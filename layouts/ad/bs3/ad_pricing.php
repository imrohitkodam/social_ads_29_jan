			...
			<div class="container-fluid">
				...
				<div class="form-group">
					...
					{ ?>
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
							...
							<?php echo HTMLHelper::_('select.genericlist', $singleselect, "chargeoption", 'class="ad-pricing chzn-done" onchange="sa.create.calculateTotal()" ' . $disabled . '', "value", "text", $ad_chargeoption);
				...
				<div class="form-group" id="priceperdate" style="<?php echo $display_style; ?>">
					...
					if ($ad_daterangefrom && isset($ad_daterangefrom))
					{
						...
						<div class="ad-price-lable col-lg-9 col-md-9 col-sm-12 col-xs-12">
							<?php echo HTMLHelper::_("calendar", $ad_daterangefrom , "datefrom", "datefrom", "%Y-%m-%d", 'class="ad-pricing", onchange="sa.create.calculateTotal()"'); ?>
							<!--
				...
				if (isset($ad_chargeoption) && $ad_chargeoption == 2 && $displayData->addata_for_adsumary_edit && $displayData->addata_for_adsumary_edit->ad_enddate)
				{
					...
					<div class="form-group">
						...
						<label class="ad-price-lable col-lg-3 col-md-3 col-sm-4 col-xs-12" width="40%">
				...
				<div class="form-group" id="total_days" style="<?php echo $date_dis; ?>">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						...
						{
						?>
							<div class="alert alert-info sa-mt-1">
				...
				<?php
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
							<input type="text" maxlength="10" name="totaldisplay" class="ad-pricing input-medium cal_text" id="totaldisplay" value="<?php echo $ad_totaldisplay; ?>" onchange="sa.create.calculateTotal()"  />
						</div>
					</div>
				...
				<div class = "form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 cal_text">
						...
						<div class="totalPriceWithPlatformFee alert alert-info sa-mt-3 d-none">
