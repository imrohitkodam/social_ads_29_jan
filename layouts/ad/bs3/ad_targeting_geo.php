			...
			if ($displayData->geodbfile_exists)
			{
				...
				<div id="mapping-field-table">
					<div class="form-group row">
						<label class="col-md-3" label-default for="" title="<?php echo Text::_('COM_SOCIALADS_AD_GEO_COUNTRY');?>">
					...
					<div class="form-group row">
						<div class="col-lg-12 col-md-12 col-sm-9 col-xs-12">
							<div id ="geo_others" style="display:none;">
								<div class="radio">
									<label label-default class="saradiolabel col-md-4" for="everywhere"><input type="radio"
								...
								<div class="row" <?php echo in_array('byregion', $displayData->sa_params->get('geo_options')) ? '' :'style="display:none;"'; ?> >
									<div class="radio col-md-4">
										<label label-default class="saradiolabel" for="byregion">
											<input type="radio"
									...
									<ul style="display:none;" class="selections col-md-6 byregion_ul" id='selections_region' >
								...
								<div class="row" <?php echo in_array('bycity', $displayData->sa_params->get('geo_options')) ? '' : 'style="display:none;"'; ?>>
									<div class="radio col-md-4">
										<label label-default class="saradiolabel" for="bycity">
											<input type="radio"
									...
									<ul style="display:none;" class="selections col-md-6 bycity_ul"  id='selections_city' >
