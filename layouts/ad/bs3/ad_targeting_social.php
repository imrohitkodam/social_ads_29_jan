													...
													*/
													...
													if ($fields->mapping_fieldtype == "numericrange")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . '_low']) || isset($displayData->addata_for_adsumary_edit->$lowvar))
														{
															...
															if ($displayData->edit_ad_id)
															{
																...
																<input type="textbox" class="sa-fields-inputbox form-control input-small"
														...
														{
															?>
															<input type="textbox"  class="sa-fields-inputbox form-control input-small" name="mapdata[][<?php echo $fields->mapping_fieldname . '_low|numericrange|0'; ?>]"
																value=""
																<?php echo $displayReachCount; ?>
																<?php echo $onkeyup; ?> />
															...
															<input type="textbox" class="sa-fields-inputbox form-control input-small" name="mapdata[][<?php echo $fields->mapping_fieldname . '_high|numericrange|1'; ?>]"
													...
													if ($fields->mapping_fieldtype == "textbox")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname]) || isset($displayData->addata_for_adsumary_edit->$textvar))
														{
															...
															{
																?>
																<input type="textbox" class="sa-fields-inputbox form-control" name="mapdata[][<?php  echo $fields->mapping_fieldname; ?>]"
													...
													if ($fields->mapping_fieldtype == "singleselect")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . ',select']) || isset($displayData->addata_for_adsumary_edit->$singlevar))
														{
															...
															if ($displayData->edit_ad_id)
															{
																...
																echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', 'class="sa-fields-inputbox chzn-done form-select" size="1" ' . $displayReachCount, 'value', 'text', $mdata);
															}
															else
															{
																echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', ' class="sa-fields-inputbox chzn-done form-select"' . $displayReachCount . ' id="mapdata[][' . $fields->mapping_fieldname . ',select]" size="1"', 'value', 'text', $displayData->flds[$fields->mapping_fieldname . ',select']);
															}
														...
														else
														{
															...
															echo HTMLHelper::_('select.genericlist', $options, 'mapdata[][' . $fields->mapping_fieldname . ',select]', 'class="sa-fields-inputbox chzn-done form-select"  id="mapdata[][' . $fields->mapping_fieldname . ',select]"' . $displayReachCount . ' size="1"', 'value', 'text', '');
													...
													if ($fields->mapping_fieldtype == "daterange")
													{
														...
														if (isset($displayData->flds[$fields->mapping_fieldname . '_low']) || isset($displayData->addata_for_adsumary_edit->$datelowvar))
														{
															...
															if ($displayData->edit_ad_id)
															{
																...
																echo HTMLHelper::_('calendar', $displayData->addata_for_adsumary_edit->$datelowvar, 'mapdata[][' . $fields->mapping_fieldname . '_low|daterange|0]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox input-small', $displayReachFunction));

																echo Text::_('COM_SOCIALADS_TO');

																echo HTMLHelper::_('calendar', $displayData->addata_for_adsumary_edit->$datehighvar, 'mapdata[][' . $fields->mapping_fieldname . '_high|daterange|1]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox input-small', $displayReachFunction));
															}
																else
																{
																	...
																	echo HTMLHelper::_('calendar', $displayData->flds[$fields->mapping_fieldname . '_low'], 'mapdata[][' . $fields->mapping_fieldname . '_low]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_low]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox input-small', $displayReachFunction));
																	echo Text::_('COM_SOCIALADS_TO');
																	echo HTMLHelper::_('calendar', $displayData->flds[$fields->mapping_fieldname . '_high'], 'mapdata[][' . $fields->mapping_fieldname . '_high]', 'mapdata[' . $key . '][' . $fields->mapping_fieldname . '_high]', '%Y-%m-%d', array('class' => 'sa-fields-inputbox input-small', $displayReachFunction));
																}
														}
														else
														{
