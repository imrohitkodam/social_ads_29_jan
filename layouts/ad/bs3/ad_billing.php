		...
		<div id="ads_mainwrapper" class="row form-horizontal">
			...
			?>
				<div class="form-group">
					...
					<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
						<input id="mnam" class="input-medium bill inputbox required validate-name" type="text"
			...
			<div class="form-group">
				...
				<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
					...
					value="<?php echo (isset($userbill->lastname))?$userbill->lastname:''; ?>" maxlength="250"
					size="32" name="bill[lnam]" title="<?php echo Text::_('COM_SOCIALADS_BILLING_LNAM_DESC')?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
					<input id="email1" class="input-medium bill inputbox required validate-email" type="text"
			...
			?>
				<div class="form-group">
					<label label-default for="vat_num"  class="col-lg-2 col-md-2 col-sm-3 col-xs-12"><?php echo  Text::_('COM_SOCIALADS_BILLING_VAT_NUM')?></label>
					<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
						<input id="vat_num" class="input-small bill inputbox validate-integer" type="text"
						value="<?php echo (isset($userbill->vat_number))?$userbill->vat_number:''; ?>" size="32"
						name="bill[vat_num]" title="<?php echo Text::_('COM_SOCIALADS_BILLING_VAT_NUM_DESC')?>">
					</div>
				</div>
			<?php
			}
			...
			<div class="form-group">
				...
				<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
					<textarea id="addr" class="input-medium bill inputbox required" name="bill[addr]" maxlength="250" rows="3" title="<?php echo Text::_('COM_SOCIALADS_BILLING_ADDR_DESC')?>" ><?php echo (isset($userbill->address))?$userbill->address:''; ?></textarea>
			...
			<div class="form-group">
				...
				<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
					<input id="zip"  class="input-small bill inputbox required " type="text"
					value="<?php echo (isset($userbill->zipcode))?$userbill->zipcode:''; ?>"  maxlength="20"
					size="32" name="bill[zip]" title="<?php echo Text::_('COM_SOCIALADS_BILLING_ZIP_DESC')?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
					...
					value="<?php echo (isset($userbill->city))?$userbill->city:''; ?>" maxlength="250"
					size="32" name="bill[city]" title="<?php echo Text::_('COM_SOCIALADS_BILLING_CITY_DESC')?>">
				</div>
			</div>
		</div>
	</div>
