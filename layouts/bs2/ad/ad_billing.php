...
<fieldset class="sa-fieldset">
	...
	<div id="ads_mainwrapper" class="row-fluid form-horizontal">
		...
		?>
			<div class="control-group">
				<label for="vat_num"  class="control-label"><?php echo  Text::_('COM_SOCIALADS_BILLING_VAT_NUM')?></label>
				<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="city" class="input-medium bill inputbox required validate-name"
