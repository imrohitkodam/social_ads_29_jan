	...
	<fieldset class="sa-fieldset">
		<div class="form-horizontal buildad_pricing_tab">
			...
			else
			{
				...
				elseif (is_array($pricing_options) && (count((array)$pricing_options)==1 && $pricing_options[0] == 'perday'))
				{
					$display_style	=	"display:display";
				}
				else
			...
			<div class="sa_hideForUnlimitedads" >
				...
				<div class="control-group sa_cop_details " style="display:none;" >
					<label class="control-label"><?php echo Text::_("COM_SOCIALADS_COUPON_PRICE") ?></label>
						<div class="controls" id="sa_cop_afterprice">
						</div>
				</div>

				<div class="control-group sa_cop_details " style="display:none;" >
					<label class="control-label"> <?php echo Text::_("COM_SOCIALADS_AFTER_COUPON_PRICE") ?></label>
